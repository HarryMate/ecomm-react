...
const Payment = () => {
    ...
    return (
        <>
            {size ? <div className='payment'>
                <div className="payment_container_small">
                    ...
                    <div className="payment_right_small">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="payment_section">
                                ...
                                <div className="payment_details">
                                    <CardElement className='card_small' onChange={handleChange} />
